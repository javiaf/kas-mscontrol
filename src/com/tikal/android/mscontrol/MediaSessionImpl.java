...
import com.tikal.android.mscontrol.mediacomponent.MediaComponentBase;
...
public class MediaSessionImpl implements MediaSessionAndroid {
	...
	public MediaComponent createMediaComponent(Configuration<MediaComponent> predefinedConfig,
		...
		if (MediaComponentBase.AUDIO_PLAYER.equals(predefinedConfig))
			return new AudioPlayerComponent();
		else if (MediaComponentBase.AUDIO_RECORDER.equals(predefinedConfig))
			return new AudioRecorderComponent(params);
		else if (MediaComponentBase.VIDEO_PLAYER.equals(predefinedConfig))
			return new VideoPlayerComponent(params);
		else if (MediaComponentBase.VIDEO_RECORDER.equals(predefinedConfig))
